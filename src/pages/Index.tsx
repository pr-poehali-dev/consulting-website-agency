          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              ...
              <p className="font-body text-gray-300 leading-relaxed mb-6">
                ЛексБух Консалтинг основан в 2008 году. Мы объединили под одной крышей опытных бухгалтеров, налоговых консультантов и юристов — чтобы вы получали комплексную защиту без необходимости обращаться в несколько мест.
              </p>
